...
/*WriteLine("Running methods synhronously on one thread.");
MethodA();
MethodB();
MethodC();*

WriteLine("Running methods asynhronously on one thread.");
...
WriteLine($"{timer.ElapsedMilliseconds:#,##0}ms elsaped.");

//Sinhrono pokretanje vise akcija
