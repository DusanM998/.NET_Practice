...
//Pristupanje resursu iz vise programskih niti
...
WriteLine($"{watch.ElapsedMilliseconds:N0} elapsed miliseconds.");
WriteLine($"{SharedObjects.Counter} string modifications");

static void MethodA()
{
    // Sprecavanje kruzne blokade pomocu bloka try
    try
    {
        ...
        {
            WriteLine("Method A timed out wthen entering a monitor on conch.");
        }
    }
    finally
    {
