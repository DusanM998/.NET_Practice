...
{
    //Definisanje fajla za upis(write)
...
static void WorkWithXml()
{
    ...
    try
    {
        ...
        foreach(string item in Viper.Callsigns)
        {
            xml.WriteElementString("calsign", item);
        }
    ...
    catch(Exception ex) //Za uklanjanje resursa fajla
    {
...
static class Viper
{
    //Define a array of Viper pilot call sings
