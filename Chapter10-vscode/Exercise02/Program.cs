/*---------------------------------------
    Konzolna aplikacija koja salje upit Northwind bazi podataka za sve kategorije
    i proizvode, a zatim serijalizuje podatke koristeci najmanje tri formata serijalizacije
---------------------------------------*/
using System.Xml; // XmlWriter
using System.Text.Json;
using Microsoft.EntityFrameworkCore; // Include extension method
using Packt.Shared; // Category, Product, Northwind
...
{
    //Upit koji vraca sve kategorije i njihove povezane proizvode
        ...
        using (Utf8JsonWriter json = new(jsonStream,
          new JsonWriterOptions {Indented = true}))
          {
            ...
            foreach(Category c in categories)
            {
                ...
                json.WriteString("description", c.Description);
