...
/*if(AddProduct(categoryId: 6, 
    productName: "Bob's burger",price: 500M))
{
    WriteLine("Product added succesful.");
}*/

/*if(IncreaseProductPrice(productNameStartsWith: "Bob", amount: 200M))
{
    WriteLine($"Update product price succesfull.");
}*/
...
static void QueryingCategories()
{
    ...
    {
        //Evidentiranje radnog okvira EF Core pomocu
        //prilagodjenog provajdera za evidentiranje
...
static void FilteredIncludes()
{
    using (Northwind db = new())
    {
        ...
        //Preuzimanje generisanog SQL iskaza
...
static void QueryingProducts()
{
    ...
    using (Northwind db = new())
    {
        ...
        IQueryable<Product>? products = db.Products?
            .TagWith("Products filtered by price and sorted.") //Evidentiranje pomocu oznaka upita
...
static bool IncreaseProductPrice(string productNameStartsWith, decimal amount)
{
    using(Northwind db = new())
    {
        //Get firts product whose name starts with name
