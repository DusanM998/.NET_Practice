...
//Classlib koja def. prosirene metode koji prosiruju tipove brojeva
//kao sto su BigInteger i int pomocu metoda pod nazivom ToWords
public static class NumbersToWords
{
    ...
    //Imena desetine brojeva od deset navise
    ...
    //Imena brojeva skale za upotrebu tokom rekombinacije
    ...
    public static string ToWords(this BigInteger number)
    {
        ...
        */
        ...
        //Convert each three-digit groups to words
